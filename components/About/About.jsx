        ...
        <ul className="textList">
          <li className="text">
            ...
            <div>
              ...
              алкоголь у будь-якому сегменті не тільки в офлайн-магазинах, але й
              серед купівлі онлайн. При цьому забезпечується найвищий рівень
          ...
          <li className="text">
            ...
            <div>
              ...
              залишаються незмінними! Ми даємо найнижчу ціну на коктейлі за
              оригінальною рецептурою з використанням справжніх інгредієнтів.
