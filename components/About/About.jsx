      ...
      <Container>
        ...
        <ul className="textList">
          <li className="text">
            ...
            <div>
              <span>МАГАЗИН</span> - концепція яка привертає увагу своїми
              найнижчими цінами на алкоголь будь-якого сегменту не тільки
              offline магазинів, але і серед online продажів. При цьому
              надається максимальний рівень обслуговування, яким задоволені всі
              покупці.
            </div>
          </li>
          <li className="text">
            ...
            <div>
              ...
              різні об'єми замовника. Починаючи від пляшки та закінчуючи ящиками
              і ціна буде найнижча на ринку. 
            </div>
          </li>
          <li className="text">
            <div className="redPoint"></div>
